...
module.exports = angular.module('spinnaker.aws.serverGroup.configure.service', [
  ...
  .factory('awsServerGroupConfigurationService', function($q, awsImageReader, accountService, securityGroupReader,
    ...
    var groupMetrics = ['GroupMinSize', 'GroupMaxSize', 'GroupDesiredCapacity', 'GroupInServiceInstances', 'GroupPendingInstances', 'GroupStandbyInstances', 'GroupTerminatingInstances', 'GroupTotalInstances'],
    ...
    function configureUpdateCommand(command) {
      command.backingData = {
        groupMetrics: angular.copy(groupMetrics),
    ...
    function configureCommand(application, command) {
      ...
      return $q.all({
        ...
        groupMetrics: $q.when(angular.copy(groupMetrics)),
